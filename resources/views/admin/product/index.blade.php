                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td> {{$row->color}} </td>
                                        <td> {{$row->price}} </td>
                                        <td> <img src="{{asset('uploads/products/'.$row->image)}}"  width="50" height="50" /> </td>
                                        <td> <a href="{{route('product.edit',$row->id)}}"><i class="fa fa-eye text-primary" aria-hidden="true"></i></a></td>
                                        <td>
                                            <form action="{{url('admin/product/delete/'.$row->id)}}" class="ml-2" method="post">
                                                @method("DELETE")
                                                @csrf
                                                <button type="submit" style="border:0 solid black; background-color: transparent;"><i class="fa fa-trash-o text-danger" aria-hidden="true"></i></button>
                                            </form>
                                        </td>
                                    </tr>
                                    </tbody>
