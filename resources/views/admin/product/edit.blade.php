                ...
                <ul class="iconMenu-bar custom-scrollbar">
                    <li><a class="bar-icons" href="javascript:void(0)">
                        ...
                        <ul class="iconbar-mainmenu custom-scrollbar">
                            ...
                            <li><a href="{{url('admin/dashboard')}}">داشبورد</a></li>

                        </ul>
                    </li>


                    <li><a class="bar-icons" href="javascript:void(0)"><i class="fa fa-shopping-cart"></i><span> محصولات </span></a>
                        <ul class="iconbar-mainmenu custom-scrollbar">
                            <li class = "iconbar-header"> مدیریت محصولات </li>
                            <li> <a href="{{route('product.create')}}"> ساخت محصول جدید </a> </li>
                    ...
                    <li><a class="bar-icons" href="javascript:void(0)"><i class="fa fa-user"></i><span> کامپونت ها </span></a>
                        <ul class="iconbar-mainmenu custom-scrollbar">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <form class="form theme-form" method="POST" action="{{route('product.update',$car->id)}}" enctype="multipart/form-data">
                            @method("PUT")
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label"> نام خودرو</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا نام خودرو را وارد کنید" name="name" value="{{$car->name}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">مدل</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="number" name="model" value="{{$car->model}}" placeholder="لطفا مدل را وارد کنید">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">رنگ</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا رنگ را وارد کنید" name="color" value="{{$car->color}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">قیمت</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا قیمت را وارد کنید" name="price" value="{{$car->price}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <br>
                                                    <img src="{{asset('uploads/products/'.$car->image)}}"  width="80" height="80" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
