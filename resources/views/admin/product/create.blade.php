                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا نام خودرو را وارد کنید" name="name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="number" name="model" placeholder="لطفا مدل را وارد کنید">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">رنگ</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا رنگ را وارد کنید" name="color">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-sm-3 col-form-label">قیمت</label>
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا قیمت را وارد کنید" name="price">
                                                </div>
                                            </div>
                                            <div class="form-group row">
