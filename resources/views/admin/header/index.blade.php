                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 breadcrumb-right">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">نمایش هدر</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th scope="row">1</th>
                                            <td> {{$header->title}} </td>
                                            <td> <img src="{{asset('uploads/header/'.$header->image)}}"  width="50" height="50" /> </td>
                                            <td> <a href="{{url('admin/header/edit')}}"><i class="fa fa-eye text-primary" aria-hidden="true"></i></a></td>
