                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="text" placeholder="لطفا عنوان را وارد کنید" name="title" value="{{$header->title}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <br>
                                                    <img src="{{asset('uploads/header/'.$header->image)}}"  width="80" height="80" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
